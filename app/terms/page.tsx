      ...
      <section className="pt-24 sm:pt-28 md:pt-32 pb-16 sm:pb-20 md:pb-24 px-4 sm:px-6 md:px-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none space-y-6 sm:space-y-8 text-black">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-black mt-6 sm:mt-8 mb-3 sm:mb-4"><span className="text-red-600">4.</span> Contractual <span className="text-red-600">Relationship</span></h2>
              <p className="text-black">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-black mt-6 sm:mt-8 mb-3 sm:mb-4"><span className="text-red-600">5.</span> Intellectual Property <span className="text-red-600">Rights</span></h2>
              <p className="text-black">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-black mt-6 sm:mt-8 mb-3 sm:mb-4"><span className="text-red-600">6.</span> Payments and <span className="text-red-600">Invoicing</span></h2>
              <p className="text-black">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-black mt-6 sm:mt-8 mb-3 sm:mb-4"><span className="text-red-600">7.</span> Limitation of <span className="text-red-600">Liability</span></h2>
              <p className="text-black">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-black mt-6 sm:mt-8 mb-3 sm:mb-4"><span className="text-red-600">8.</span> Disclaimer of <span className="text-red-600">Warranties</span></h2>
              <p className="text-black">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-black mt-6 sm:mt-8 mb-3 sm:mb-4"><span className="text-red-600">9.</span> Confidentiality</h2>
              <p className="text-black">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-black mt-6 sm:mt-8 mb-3 sm:mb-4"><span className="text-red-600">10.</span> Governing Law and Jurisdiction</h2>
              <p className="text-black">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-black mt-6 sm:mt-8 mb-3 sm:mb-4"><span className="text-red-600">11.</span> Acceptance of Terms</h2>
              <p className="text-black">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-black mt-6 sm:mt-8 mb-3 sm:mb-4"><span className="text-red-600">12.</span> Contact Information</h2>
              <p className="text-black">
