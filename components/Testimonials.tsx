...
const TestimonialCard = ({ testimonial, index }: { testimonial: typeof testimonials[0], index: number }) => (
    <motion.div
        ...
        className="w-full bg-white rounded-[32px] p-8 border border-gray-100 shadow-sm flex flex-col justify-between min-h-[340px]"
    >
...
const Testimonials = () => {
    ...
    return (
        <section id="achievements" className="relative w-full py-16 bg-white">
