...
export function DashboardClient({ initialCareers }: { initialCareers: Career[] }) {
    ...
    const inputClass = "w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all duration-200 text-gray-900 placeholder-gray-400 text-sm";
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex font-sans">
            ...
            {/* Sidebar */}
            <aside className={`
                fixed inset-y-0 left-0 z-30 w-64 bg-black text-white transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:h-screen overflow-y-auto
                ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"}
            `}>
                <div className="p-8 border-b border-white/10">
                    <h1 className="text-2xl font-bold tracking-tight text-white">Redlix<span className="text-orange-500">.</span></h1>
                    <p className="text-xs text-gray-400 mt-1">Administration Console</p>
                </div>
                ...
                <nav className="mt-8 px-4 space-y-2">
                    ...
                    >
                        ...
                        {allApplications.length > 0 && (
                            <span className={`ml-auto py-0.5 px-2 rounded-full text-xs font-bold ${activeView === "applications" ? "bg-black text-white" : "bg-white/10 text-white"
                                }`}>
            ...
            {/* Main Content */}
            <main className="flex-1 lg:p-10 p-4 pt-20 lg:pt-10 bg-gray-50 h-screen overflow-y-auto">
                    ...
                    {activeView === "jobs" && (
                        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                            ...
                            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                                {/* Add Career Form */}
                                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 h-fit sticky top-10">
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-5">
                                        ...
                                        <div className="bg-gray-50/50 p-4 rounded-xl border border-dashed border-gray-200">
                                            <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">External Opportunity (Optional)</h3>
                                            <div className="grid grid-cols-2 gap-4">
                                                <div>
                                        ...
                                        <button
                                            type="submit"
                                            disabled={loading}
                                            className="w-full bg-black text-white font-semibold py-3 rounded-lg hover:bg-gray-800 transition-all duration-200 disabled:opacity-70 disabled:cursor-not-allowed shadow-md hover:shadow-xl mt-4 flex justify-center items-center gap-2"
                                        >
                                ...
                                <div className="xl:col-span-2 space-y-4">
                                    ...
                                    {careers.map((career) => (
                                        <div
                                            key={career.id}
                                            className="bg-white p-6 rounded-xl border border-gray-200 hover:shadow-md transition-all duration-200 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 group"
                                        >
                                            <div className="space-y-3 flex-grow min-w-0">
                                                ...
                                                <div className="pt-2">
                                                    <button
                                                        ...
                                                        className="text-sm font-semibold text-blue-600 hover:text-blue-800 hover:underline flex items-center gap-1.5 transition-colors"
                                                    >
                                                        View Applications <span className="bg-blue-50 text-blue-700 px-1.5 py-0.5 rounded text-xs ml-1">{career.applications?.length || 0}</span>
                                                    </button>
                                                </div>
                                            </div>
                                            <div className="flex items-center gap-3">
