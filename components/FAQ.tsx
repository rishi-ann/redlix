        ...
        <div className="border-b border-gray-100 last:border-0">
            ...
            >
                <div className="flex-1 pr-8">
                    <span className={`text-[16px] md:text-[18px] tracking-tight transition-colors duration-300 ${faq.special ? "text-red-500 font-semibold" :
            ...
            <AnimatePresence>
                {isOpen && (
                    ...
                    >
                        <p className="pb-8 text-gray-400 leading-relaxed font-normal text-[14px] md:text-[15px] max-w-2xl">
...
const FAQ = () => {
    return (
        <section id="faqs" className="relative w-full py-16 bg-white">
            ...
            <div className="max-w-6xl mx-auto px-12 md:px-24">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                    <div className="max-w-md">
                        <h2 className="text-3xl md:text-4xl font-medium text-gray-900 tracking-tight leading-tight">
