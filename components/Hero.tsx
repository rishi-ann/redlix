...
const Hero = () => {
    return (
        <section className="relative w-full pt-32 pb-10 bg-white overflow-hidden">
            <div
                className={cn(
            ...
            <div className="relative z-10 max-w-[1440px] mx-auto px-6">
                ...
                <div className="max-w-3xl mx-auto text-left sm:text-center">
                    ...
                    <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-gray-50 border border-gray-200/60 mb-8 shadow-[0_2px_10px_rgba(0,0,0,0.02)] group cursor-default select-none animate-in fade-in slide-in-from-top-4 duration-1000">
                        <span className="flex h-1.5 w-1.5 rounded-full bg-green-500 shadow-[0_0_10px_rgba(34,197,94,0.5)] animate-pulse"></span>
                        <span className="text-[12px] font-normal text-gray-600 tracking-tight">
                    ...
                    <h1 className="text-4xl sm:text-5xl lg:text-6xl font-medium tracking-tight text-gray-900 leading-[1.15] mb-6">
                    ...
                    <p className="max-w-lg sm:mx-auto text-base sm:text-lg text-gray-500 mb-8 leading-relaxed font-normal">
                    ...
                    <div className="flex flex-col items-start sm:items-center gap-10">
                        <a href="https://cal.com/redlix.co.in/30min" target="_blank" rel="noopener noreferrer">
                            <button className="group relative pr-10 pl-4 py-3 bg-gray-950 text-white rounded-full font-medium text-sm transition-all duration-300 hover:bg-black hover:scale-105 active:scale-95 shadow-2xl shadow-gray-200 flex items-center gap-3 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                        ...
                        <div className="flex flex-col items-start sm:items-center gap-3">
                            <div className="flex flex-row items-center justify-start sm:justify-center mb-0 w-full">
                                ...
                                <div className="h-10 w-10 rounded-full bg-black flex items-center justify-center text-[11px] font-bold text-white ring-4 ring-white border border-gray-100 -ml-2 relative z-30">+30</div>
                            </div>
                            <p className="text-[11px] text-gray-400 font-normal tracking-wide uppercase mt-1">Trusted by 30+ Tech Founders</p>
                        </div>
                    </div>
                </div>
            </div>
