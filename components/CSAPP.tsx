...
const CSAPP = () => {
    return (
        <section id="csapp" className="relative w-full py-16 bg-[#FBFBFA] overflow-hidden">
            ...
            <div className="relative max-w-6xl mx-auto px-12 md:px-24 z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <h2 className="text-4xl md:text-5xl font-medium tracking-tight text-gray-900 mb-2 leading-tight">
                            Management <br />
                            <span className="text-gray-400 font-normal">portal.</span>
                        </h2>

                        <p className="text-2xl md:text-3xl text-gray-900 font-medium mb-8 tracking-tight">
                            Workflow <HighlightText text="simplified" />.
                        </p>

                        <p className="text-[15px] text-gray-500 font-normal leading-relaxed max-w-sm mb-8">
                        ...
                        <div className="flex items-center gap-4">
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-flex items-center gap-2 px-6 py-3 bg-black text-white rounded-full text-[14px] font-medium transition-all hover:bg-gray-800 hover:scale-105 shadow-lg shadow-gray-200"
                            >
                                Launch System
                            ...
                            <a
                                href="/csapp"
                                className="inline-flex items-center gap-2 px-6 py-3 bg-white text-gray-900 border border-gray-200 rounded-full text-[14px] font-medium transition-all hover:bg-gray-50 hover:border-gray-300"
                            >
                                Learn More
                            </a>
                        </div>
