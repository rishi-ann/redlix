...
const services = [
    ...
    },
    {
        ...
        image: "https://res.cloudinary.com/dsqqrpzfl/image/upload/v1771347776/undraw_online-shopping_hgf6_ybgapz.svg",
    },
];
...
const redKeywords = [
    ...
    "Aesthetic balance", "digital transformation", "proactive monitoring", "seamless payment integration",
    "conversion optimization", "End-to-end"
];
