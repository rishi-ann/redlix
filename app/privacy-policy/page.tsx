      ...
      <section className="pt-24 sm:pt-28 md:pt-32 pb-16 sm:pb-20 md:pb-24 px-4 sm:px-6 md:px-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none space-y-6 sm:space-y-8 text-black">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-black mt-6 sm:mt-8 mb-3 sm:mb-4"><span className="text-red-600">5.</span> Portfolio and Case Studies</h2>
              <p className="text-black">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-black mt-6 sm:mt-8 mb-3 sm:mb-4"><span className="text-red-600">6.</span> Data Security Measures</h2>
              <p className="text-black">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-black mt-6 sm:mt-8 mb-3 sm:mb-4"><span className="text-red-600">7.</span> Data Retention</h2>
              <p className="text-black">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-black mt-6 sm:mt-8 mb-3 sm:mb-4"><span className="text-red-600">8.</span> Third-Party Disclosure</h2>
              <p className="text-black">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-black mt-6 sm:mt-8 mb-3 sm:mb-4"><span className="text-red-600">9.</span> Legal Compliance</h2>
              <p className="text-black">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-black mt-6 sm:mt-8 mb-3 sm:mb-4"><span className="text-red-600">10.</span> User Rights</h2>
              <p className="text-black">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-black mt-6 sm:mt-8 mb-3 sm:mb-4"><span className="text-red-600">11.</span> Contact Us</h2>
              <p className="text-black">
