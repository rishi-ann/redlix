...
const ProjectCard = ({ project }: { project: typeof projects[0] }) => {
    return (
        <Link href={project.link} className="block group">
            <div className="w-[380px] sm:w-[480px] flex-shrink-0 bg-white border border-gray-300 rounded-[48px] p-3 flex flex-col gap-6 mx-4 hover:border-gray-400 transition-colors duration-300 cursor-pointer">
                ...
                <div className="flex flex-col gap-5">
                    <div className="bg-white rounded-[28px] p-6 shadow-sm border border-gray-100 flex flex-col gap-2">
                        <p className="text-[14px] sm:text-[15px] leading-relaxed text-gray-800 font-normal">
