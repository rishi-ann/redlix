                    ...
                    <div className="max-w-3xl">
                        ...
                        >
                            ...
                            <h1 className="text-3xl md:text-4xl lg:text-[44px] font-semibold tracking-tight text-gray-950 leading-[1.15]">
                                How HSGA Telangana and Redlix Unified Sports Administration
                            </h1>
                    ...
                    <aside className="md:col-span-3 space-y-10 order-2 md:order-1">
                        <div className="pt-2 border-t border-gray-100">
                            ...
                            <p className="text-[13px] leading-relaxed text-gray-600">
                                Pioneering the digital transformation of state-level sports administration and athlete management.
                            </p>
                        </div>
                        ...
                        <div className="pt-2 border-t border-gray-100">
                            ...
                            <p className="text-[13px] text-gray-800 font-medium">Sports / Government</p>
                        </div>

                        <div className="pt-2 border-t border-gray-100">
                            <p className="text-[10px] uppercase tracking-[0.2em] text-gray-400 mb-4 font-semibold">Project Scope</p>
                            <p className="text-[13px] text-gray-800 font-medium">HUS System (<span className="text-red-500">Infrastructure</span>)</p>
                        </div>
                    </aside>
                        ...
                        <div className="max-w-3xl w-full space-y-16">
                            <section className="space-y-6">
                                ...
                                <p className="text-[15px] leading-relaxed text-gray-600">
                                    The HUS System is a massive digital infrastructure project designed to centralize the management of sports associations, athletes, and tournaments across Telangana. It replaces fragmented paper-based processes with a unified, state-of-the-art digital backbone that ensures data integrity and real-time accessibility.
                                </p>
                            </section>

                            <section className="space-y-10">
                                <h2 className="text-xl font-medium text-gray-900">Key Infrastructure Modules</h2>

                                <div className="space-y-12">
                                    <div className="space-y-4">
                                        <h3 className="text-base font-semibold text-black flex items-center gap-2">
                                            <div className="w-1.5 h-1.5 rounded-full bg-red-500" /> Centralized Registry
                                        </h3>
                                        <ul className="space-y-3 pl-4 border-l border-gray-100">
                                            <li className="text-[13px] text-gray-600"><strong className="text-gray-900 font-medium">Athlete Database:</strong> Secure digital profiles for thousands of athletes with performance history.</li>
                                            <li className="text-[13px] text-gray-600"><strong className="text-gray-900 font-medium">Association Management:</strong> Tools for district and state associations to manage affiliations.</li>
                                        </ul>
                                    </div>

                                    <div className="space-y-4">
                                        <h3 className="text-base font-semibold text-black flex items-center gap-2">
                                            <div className="w-1.5 h-1.5 rounded-full bg-red-500" /> Tournament Operations
                                        </h3>
                                        <ul className="space-y-3 pl-4 border-l border-gray-100">
                                            <li className="text-[13px] text-gray-600"><strong className="text-gray-900 font-medium">Live Scoring:</strong> Real-time update capabilities for ongoing matches.</li>
                                        </ul>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section className="space-y-6">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {["Next.js", "Node.js", "MongoDB", "Socket.io", "AWS CloudFront", "Redis"].map((tech, i) => (
